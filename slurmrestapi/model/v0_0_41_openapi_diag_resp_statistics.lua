...
-- v0_0_41_openapi_diag_resp_statistics class
local v0_0_41_openapi_diag_resp_statistics = {}
local v0_0_41_openapi_diag_resp_statistics_mt = {
	__name = "v0_0_41_openapi_diag_resp_statistics";
	__index = v0_0_41_openapi_diag_resp_statistics;
}

local function cast_v0_0_41_openapi_diag_resp_statistics(t)
	return setmetatable(t, v0_0_41_openapi_diag_resp_statistics_mt)
end

local function new_v0_0_41_openapi_diag_resp_statistics(parts_packed, req_time, req_time_start, server_thread_count, agent_queue_size, agent_count, agent_thread_count, dbd_agent_queue_size, gettimeofday_latency, schedule_cycle_max, schedule_cycle_last, schedule_cycle_sum, schedule_cycle_total, schedule_cycle_mean, schedule_cycle_mean_depth, schedule_cycle_per_minute, schedule_cycle_depth, schedule_exit, schedule_queue_length, jobs_submitted, jobs_started, jobs_completed, jobs_canceled, jobs_failed, jobs_pending, jobs_running, job_states_ts, bf_backfilled_jobs, bf_last_backfilled_jobs, bf_backfilled_het_jobs, bf_cycle_counter, bf_cycle_mean, bf_depth_mean, bf_depth_mean_try, bf_cycle_sum, bf_cycle_last, bf_cycle_max, bf_exit, bf_last_depth, bf_last_depth_try, bf_depth_sum, bf_depth_try_sum, bf_queue_len, bf_queue_len_mean, bf_queue_len_sum, bf_table_size, bf_table_size_sum, bf_table_size_mean, bf_when_last_cycle, bf_active, rpcs_by_message_type, rpcs_by_user, pending_rpcs, pending_rpcs_by_hostlist)
	return cast_v0_0_41_openapi_diag_resp_statistics({
...
return {
	cast = cast_v0_0_41_openapi_diag_resp_statistics;
	new = new_v0_0_41_openapi_diag_resp_statistics;
}
